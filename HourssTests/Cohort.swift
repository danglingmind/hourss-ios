...
extension SyntheticCohort {
    ...
    static var walksEverywhere: Person {
        make(.init(name: "Walks everywhere", seed: 0x8B14,
    ...
    static var walksAndStrains: Person {
        make(.init(name: "Walks and strains", seed: 0x8B15,
                   walkingHabit: .init(alwaysDuring: ["Meetings"]),
                   truth: .init(
                       planted: [.movementHabit(cadence: 97, bpm: 11),
